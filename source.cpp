...
int main()
{
	...
	Node<int>::swap_two_nodes(Node<int>::search_by_value(root, 18),
				  Node<int>::search_by_value(root, 1));
	Node<int>::tree_print(root);
	cout << "______________________" << endl;
	Node<int>::swap_two_nodes(Node<int>::search_by_value(root, 29),
				  Node<int>::search_by_value(root, 1));
	Node<int>::tree_print(root);
	cout << "______________________" << endl;
	Node<int>::swap_two_nodes(Node<int>::search_by_value(root, 19),
				  Node<int>::search_by_value(root, 11));
	Node<int>::tree_print(root);
	cout << "______________________" << endl;
	cout << "Validation = " << Node<int>::BST_validate(root) << endl;
